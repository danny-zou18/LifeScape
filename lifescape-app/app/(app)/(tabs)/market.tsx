...
const Market = () => {
  ...
  const [items, setItems] = useState([
    {
      ...
      description:
        "A detailed description of Item 1. This item is perfect for your needs!",
      condition: "New",
      seller: "John Doe",
    },
    {
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/150",
      description:
        "A detailed description of Item 3. Don't miss this amazing deal!",
      condition: "Used - Good",
      seller: "Mike Johnson",
    },
    {
  ...
  const numColumns = 2;
  const itemWidth =
    (screenWidth - styles.container.padding * 2 - (numColumns - 1) * 10) /
    numColumns;
