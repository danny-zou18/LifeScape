...
const History = () => {
  ...
  const taskCount = userCharacter.Tasks ? userCharacter.Tasks.length : 0;
  const habitCount = userCharacter.Habits ? userCharacter.Habits.length : 0;
  const routineCount = userCharacter.Routine ? userCharacter.Routine.length : 0;
